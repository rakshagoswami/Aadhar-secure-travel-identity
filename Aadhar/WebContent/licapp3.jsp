...
try{
out.println("<body background='light_blue1.bmp'><form method=post action='licapp3.jsp'><TH>LICENSE TEST SCHEDULE<hr>");
...
stmt.executeUpdate("insert into schedule values(" + f1 + ",'" + f2 + "','" + f3 + "','" + f4 + "','" + f5  + "','Scheduled','" + vtype + "')");
