...
rs.close();
 ...
 rs1=stmt1.executeQuery("select pin,ano from cregn where ano in (select cid from schedule where status='Scheduled')");
out.println("<form method=post action=dt2.jsp>");
